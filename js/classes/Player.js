    ...
    for (const collisionBlock of this.collisionBlocks) {
      ...
      if (
        ...
        if (this.velocity.x < -0) {
          ...
          this.colliding.blocks.x.left = true
          this.colliding.blocks.x.right = false
          break
        }
        ...
        if (this.velocity.x > 0) {
          ...
          this.colliding.blocks.x.left = false
    ...
    for (const collisionBlock of this.collisionBlocks) {
      ...
      if (
        ...
        if (this.velocity.y < 0) {          
          ...
          this.colliding.blocks.y.above = true
          this.colliding.blocks.y.below = false          
          break
        }
